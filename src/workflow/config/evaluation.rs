...
use crate::expression::{
    Budget, ContextRequirements, EvalContext, EvaluationStage, Namespace,
...
impl Config {
    ...
    fn resolve_json_value(
        ...
        let evaluator = EvalContext {
            ...
            templates: Some(&self.compiled.template_registry),
        };
