...
tags:
  ...
  - design
  - boundaries
description: "High-level overview of tflow's domain separation, module layout, and 14 architectural dependency rules."
---

# Architecture Overview and Domain Boundaries

`tflow` is designed as an extensible terminal workflow host. Its long-term architectural structure strictly separates **configuration**, **session state**, **engine behavior**, and **terminal rendering** into distinct domains.
